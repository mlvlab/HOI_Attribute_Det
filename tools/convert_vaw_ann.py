...
if __name__ == '__main__':
    ...
    parser.add_argument('--clip_embedding_RN50', default='data/vaw/annotations/clip_embedding/RN50')
    ...
    def process(items):
        ...
        for id in img_dict:
            ...
            object_name.append(id['object_name'])
    ...
    for sp in split:
        ...
        with Pool(32) as p:
            ...
            print('DONE')
        import pdb; pdb.set_trace()
        json.dump(list(filter(None,images)), open(args.out_path[:-5]+'_orig_3_{}.json'.format(sp), 'w'))